		...
		function createLightbox(window, document, $) {
			...
			function lightbox(thing, index) {
				...
				tram(
					...
					removeClass($refs.lightbox, 'hide').focus()).add('opacity .3s').start({
					opacity: 1
				});
			...
			lightbox.build = function () {
				...
				$refs.container.on('tap', selector('view, strip'), handlerHide)
...
Webflow.require('ix').init([
	...
	, {
		"slug": "hide-video-overlay-icon"
		, "name": "Hide Video Overlay Icon"
		, "value": {
			"style": {
				"display": "none"
				, "opacity": 0
	...
	, {
		"slug": "show-video-overlay-icon"
		, "name": "Show Video overlay Icon"
		, "value": {
			"style": {}
			, "triggers": [{
				"type": "hover"
				, "selector": ".recipe-video-overlay-block"
				, "descend": true
				, "stepsA": [{
					"display": "block"
					, "opacity": 1
	...
	, {
		"slug": "show-mobile-categories"
		, "name": "Show Mobile Categories"
		, "value": {
			"style": {}
			, "triggers": [{
				"type": "click"
				, "selector": ".categories-wrapper"
				, "stepsA": [{
					"display": "block"
					, "opacity": 1
					, "height": "auto"
	...
	, {
		"slug": "hide-arrow-icon"
		, "name": "Hide Arrow Icon"
		, "value": {
			"style": {
				"opacity": 0
				, "x": "30px"
	...
	, {
		"slug": "show-arrow-icon"
		, "name": "Show Arrow Icon"
		, "value": {
			"style": {}
			, "triggers": [{
				"type": "hover"
				, "selector": ".view-recipes-icon-arrow"
				, "descend": true
				, "stepsA": [{
					"opacity": 1
				...
				, "stepsB": [{
					"opacity": 0
					, "transition": "transform 200ms ease 0ms, opacity 300ms ease 0ms"
					, "x": "30px"
					, "y": "0px"
					, "z": "0px"
				}]
		...
		, "value": {
			...
			, "triggers": [{
				...
				, "stepsA": [{
					...
					"opacity": 1
					, "transition": "transform 700ms ease-in-out-quart 0ms, opacity 400ms ease-in-out-quart 0ms"
					, "scaleX": 1
					, "scaleY": 1
					, "scaleZ": 1
				}]
		...
		, "value": {
			...
			, "triggers": [{
				...
				, "stepsA": [{
					...
					"opacity": 1
					, "transition": "transform 700ms ease-in-out-quart 0ms, opacity 700ms ease-in-out-quart 0ms"
					, "scaleX": 1.1
					, "scaleY": 1.1
					, "scaleZ": 1
				}]
